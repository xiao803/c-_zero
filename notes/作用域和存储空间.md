...
💡 补充说明
关于“取余”和“取模”：虽然常混用，但它们在处理负数时结果可能不同。不过，对于“能否用于浮点数”这个问题，区分它们不是关键。

在支持浮点数的语言中，% 的行为是计算浮点数除法的余数。例如在 Python 中，7.5 % 2.0 的结果是 1.5。
```
void calculate(){
...
![ascii](vx_images/479055774339501.png)
...
![编译汇编链接文件](vx_images/509777720574955.jpg)
